...
void split( block *fitting_slot,size_t size){
  ...
  //  new->previous=fitting_slot;
   ...
   // fitting_slot->previous = ?;//  the curr_fitting_slot point to the next free block
}
...
void MyFree(void* ptr){
    if(((void*)freeList<=ptr)&&(ptr<=(void*)(freeList+1048576))){
